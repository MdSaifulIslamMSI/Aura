// AUTO-GENERATED route-contract suite for marketApi.js — do not edit by hand.
// Regenerate with: node scripts/generate-api-client-tests.cjs marketApi.js
...
describe('marketApi route contract', () => {
    it("getBrowseFxRates calls GET /markets/fx-rates", async () => {
        await marketApi.getBrowseFxRates(anyArgs).catch(() => {});
        expect(apiFetch).toHaveBeenCalled();
        const [reqPath, options = {}] = apiFetch.mock.calls[apiFetch.mock.calls.length - 1];
        expect(String(options.method || 'GET')).toBe('GET');
        expect(String(reqPath)).toBe("/markets/fx-rates");
    });
