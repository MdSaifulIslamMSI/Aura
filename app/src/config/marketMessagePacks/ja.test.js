...
describe('marketMessagePacks/ja', () => {
  ...
  it('contains Japanese kana translations', () => {
    expect(KEYS.some((key) => /[\u3040-\u30FF]/.test(PACK[key]))).toBe(true);
  });
});
