...
describe('marketMessagePacks/hi', () => {
  ...
  it('contains Devanagari-script translations', () => {
    expect(KEYS.some((key) => /[\u0900-\u097F]/.test(PACK[key]))).toBe(true);
  });
});
