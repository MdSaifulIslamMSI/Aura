...
describe('marketMessagePacks/gu', () => {
  ...
  it('contains Gujarati-script translations', () => {
    expect(KEYS.some((key) => /[\u0A80-\u0AFF]/.test(PACK[key]))).toBe(true);
  });
});
