...
describe('marketMessagePacks/te', () => {
  ...
  it('contains Telugu-script translations', () => {
    expect(KEYS.some((key) => /[\u0C00-\u0C7F]/.test(PACK[key]))).toBe(true);
  });
});
