...
describe('marketMessagePacks/kn', () => {
  ...
  it('contains Kannada-script translations', () => {
    expect(KEYS.some((key) => /[\u0C80-\u0CFF]/.test(PACK[key]))).toBe(true);
  });
});
