...
describe('marketMessagePacks/ml', () => {
  ...
  it('contains Malayalam-script translations', () => {
    expect(KEYS.some((key) => /[\u0D00-\u0D7F]/.test(PACK[key]))).toBe(true);
  });
});
