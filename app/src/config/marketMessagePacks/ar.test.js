...
describe('marketMessagePacks/ar', () => {
  ...
  it('contains Arabic-script translations', () => {
    expect(KEYS.some((key) => /[\u0600-\u06FF]/.test(PACK[key]))).toBe(true);
  });
});
