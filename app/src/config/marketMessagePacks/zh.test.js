...
describe('marketMessagePacks/zh', () => {
  ...
  it('contains CJK ideograph translations', () => {
    expect(KEYS.some((key) => /[\u4E00-\u9FFF]/.test(PACK[key]))).toBe(true);
  });
});
