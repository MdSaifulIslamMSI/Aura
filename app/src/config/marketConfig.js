...
const MARKET_MESSAGE_PACK_LOADERS = typeof import.meta.glob === 'function'
  ...
  : {
      ...
      './marketMessagePacks/as.js': () => import('./marketMessagePacks/as.js'),
      './marketMessagePacks/gu.js': () => import('./marketMessagePacks/gu.js'),
      './marketMessagePacks/hi.js': () => import('./marketMessagePacks/hi.js'),
      './marketMessagePacks/ja.js': () => import('./marketMessagePacks/ja.js'),
      './marketMessagePacks/kn.js': () => import('./marketMessagePacks/kn.js'),
      './marketMessagePacks/ml.js': () => import('./marketMessagePacks/ml.js'),
      './marketMessagePacks/mr.js': () => import('./marketMessagePacks/mr.js'),
      './marketMessagePacks/or.js': () => import('./marketMessagePacks/or.js'),
      './marketMessagePacks/pa.js': () => import('./marketMessagePacks/pa.js'),
      './marketMessagePacks/pt.js': () => import('./marketMessagePacks/pt.js'),
      './marketMessagePacks/sa.js': () => import('./marketMessagePacks/sa.js'),
      './marketMessagePacks/te.js': () => import('./marketMessagePacks/te.js'),
      './marketMessagePacks/ur.js': () => import('./marketMessagePacks/ur.js'),
...
export const SUPPORTED_LANGUAGES = [
  ...
  { code: 'te', label: 'Telugu', nativeLabel: 'తెలుగు', direction: 'ltr', defaultLocale: 'te-IN' },
  { code: 'mr', label: 'Marathi', nativeLabel: 'मराठी', direction: 'ltr', defaultLocale: 'mr-IN' },
  { code: 'ur', label: 'Urdu', nativeLabel: 'اردو', direction: 'rtl', defaultLocale: 'ur-IN' },
  { code: 'gu', label: 'Gujarati', nativeLabel: 'ગુજરાતી', direction: 'ltr', defaultLocale: 'gu-IN' },
  { code: 'pa', label: 'Punjabi', nativeLabel: 'ਪੰਜਾਬੀ', direction: 'ltr', defaultLocale: 'pa-IN' },
  { code: 'ml', label: 'Malayalam', nativeLabel: 'മലയാളം', direction: 'ltr', defaultLocale: 'ml-IN' },
  { code: 'kn', label: 'Kannada', nativeLabel: 'ಕನ್ನಡ', direction: 'ltr', defaultLocale: 'kn-IN' },
  { code: 'or', label: 'Odia', nativeLabel: 'ଓଡ଼ିଆ', direction: 'ltr', defaultLocale: 'or-IN' },
  { code: 'as', label: 'Assamese', nativeLabel: 'অসমীয়া', direction: 'ltr', defaultLocale: 'as-IN' },
  { code: 'sa', label: 'Sanskrit', nativeLabel: 'संस्कृतम्', direction: 'ltr', defaultLocale: 'sa-IN' },
...
const SIMPLE_OVERRIDES = {
  ...
  es: {
    ...
    'login.signal.socialExpanded': '{{providers}} listos',
    'profile.message.providerLinkUnavailable': 'El enlace de {{provider}} no esta disponible en esta version.',
    'profile.message.providerLinkRedirect': 'Completa el enlace de {{provider}} en la ventana del proveedor.',
    'profile.message.providerAlreadyLinked': '{{provider}} ya esta vinculado a esta cuenta.',
    'profile.message.providerLinked': '{{provider}} se vinculo a esta cuenta.',
    'profile.message.providerLinkFailed': 'No se pudo vincular {{provider}}.',
    'profile.settings.security.linkedProviders': 'Proveedores de inicio de sesion vinculados',
    'profile.settings.security.linkedProvidersBody': 'Agrega otro proveedor despues de iniciar sesion con el metodo que ya posee este correo.',
    'profile.settings.security.providerLink': 'Vincular {{provider}}',
    'profile.settings.security.providerLinked': '{{provider}} vinculado',
    'profile.settings.security.providerLinking': 'Vinculando {{provider}}...',
  },
  fr: {
    'assistant.action.cart.addUnavailableProduct': 'Ce produit est indisponible ou en rupture de stock, je ne l’ai donc pas ajouté à votre panier.',
    'assistant.capability.available': 'Disponible',
    'assistant.capability.checking': 'Vérification en cours',
    'assistant.capability.unavailable': 'Indisponible',
    ...
    'assistant.context.cartEmpty': 'Panier vide',
    'assistant.context.cartSummary': 'Panier : {{count}} · {{subtotal}}',
    'assistant.fastStarts.badge': 'Contexte de la boutique vérifié',
    'assistant.fastStarts.description': 'Choisissez une tâche. L’assistant utilise le contexte actuel de la boutique, explique les compromis et demande confirmation avant toute action modifiant votre compte.',
    ...
    'assistant.product.ratingSummary': '{{rating}} sur 5 d’après {{count,number}} avis',
    ...
    'assistant.provider.localToolsReady': 'Outils locaux de la boutique prêts',
    'assistant.readiness.localCoreReady': 'L’aide dans l’application, la vérification du panier et les outils de la boutique restent disponibles sans modèle. La prise en charge des médias apparaît dès qu’elle est prête.',
    'assistant.sidebar.readiness': 'Disponibilité de l’assistant',
    'assistant.starter.launch': 'Demander maintenant',
    'assistant.starter.stage': 'Préparer',
    ...
    'login.signal.socialExpanded': '{{providers}} prets',
    'profile.message.providerLinkUnavailable': 'Le lien {{provider}} n est pas disponible dans cette version.',
    'profile.message.providerLinkRedirect': 'Terminez l association {{provider}} dans la fenetre du fournisseur.',
    'profile.message.providerAlreadyLinked': '{{provider}} est deja lie a ce compte.',
    'profile.message.providerLinked': '{{provider}} est lie a ce compte.',
    'profile.message.providerLinkFailed': 'Impossible de lier {{provider}}.',
    'profile.settings.security.linkedProviders': 'Fournisseurs de connexion lies',
    'profile.settings.security.linkedProvidersBody': 'Ajoutez un autre fournisseur apres vous etre connecte avec la methode qui possede deja cet email.',
    'profile.settings.security.providerLink': 'Lier {{provider}}',
    'profile.settings.security.providerLinked': '{{provider}} lie',
    'profile.settings.security.providerLinking': 'Liaison de {{provider}}...',
  },
  de: {
    'assistant.action.cart.addUnavailableProduct': 'Dieses Produkt ist nicht verfügbar oder ausverkauft, daher habe ich es nicht in Ihren Warenkorb gelegt.',
    'assistant.capability.available': 'Verfügbar',
    'assistant.capability.checking': 'Wird geprüft',
    'assistant.capability.unavailable': 'Nicht verfügbar',
    ...
    'assistant.context.cartEmpty': 'Warenkorb leer',
    'assistant.context.cartSummary': 'Warenkorb: {{count}} · {{subtotal}}',
    'assistant.fastStarts.badge': 'Verifizierter Shop-Kontext',
    'assistant.fastStarts.description': 'Wählen Sie eine Aufgabe. Der Assistent nutzt den aktuellen Shop-Kontext, erklärt Abwägungen und fragt vor jeder kontoverändernden Aktion nach.',
    ...
    'assistant.product.ratingSummary': '{{rating}} von 5 bei {{count,number}} Bewertungen',
    'assistant.product.warrantyLabel': 'Garantie:',
    ...
    'assistant.provider.localToolsReady': 'Lokale Shop-Werkzeuge bereit',
    'assistant.readiness.localCoreReady': 'App-Hilfe, Warenkorbprüfung und angebundene Shop-Werkzeuge bleiben ohne Modell verfügbar. Medienunterstützung erscheint, sobald sie bereit ist.',
    'assistant.sidebar.readiness': 'Bereitschaft des Assistenten',
    'assistant.starter.launch': 'Jetzt fragen',
    'assistant.starter.stage': 'Vorbereiten',
    ...
    'profile.message.providerLinkUnavailable': '{{provider}}-Verknupfung ist in diesem Build nicht verfugbar.',
    'profile.message.providerLinkRedirect': 'Schliessen Sie die {{provider}}-Verknupfung im Anbieterfenster ab.',
    'profile.message.providerAlreadyLinked': '{{provider}} ist bereits mit diesem Konto verknupft.',
    'profile.message.providerLinked': '{{provider}} wurde mit diesem Konto verknupft.',
    'profile.message.providerLinkFailed': '{{provider}} konnte nicht verknupft werden.',
    'profile.settings.security.linkedProviders': 'Verknupfte Anmeldeanbieter',
    'profile.settings.security.linkedProvidersBody': 'Fugen Sie einen weiteren Anbieter hinzu, nachdem Sie sich mit der Methode angemeldet haben, der diese E-Mail bereits gehort.',
    'profile.settings.security.providerLink': '{{provider}} verknupfen',
    'profile.settings.security.providerLinked': '{{provider}} verknupft',
    'profile.settings.security.providerLinking': '{{provider}} wird verknupft...',
  },
  ar: {
    'market.title': 'Market Studio',
  ...
  ja: {
    ...
    'voice.title': 'Aura Voice Assistant',
    'footer.headline': 'Commerce should feel assured before it feels fast.',
    'login.signal.socialExpanded': '{{providers}} の準備ができました',
    'profile.message.providerLinkUnavailable': 'このビルドでは {{provider}} の連携は利用できません。',
    'profile.message.providerLinkRedirect': 'プロバイダーのウィンドウで {{provider}} 連携を完了してください。',
    'profile.message.providerAlreadyLinked': '{{provider}} はすでにこのアカウントに連携されています。',
    'profile.message.providerLinked': '{{provider}} をこのアカウントに連携しました。',
    'profile.message.providerLinkFailed': '{{provider}} を連携できませんでした。',
    'profile.settings.security.linkedProviders': '連携済みサインインプロバイダー',
    'profile.settings.security.linkedProvidersBody': 'このメールをすでに所有している方法でサインインしてから、別のプロバイダーを追加してください。',
    'profile.settings.security.providerLink': '{{provider}} を連携',
    'profile.settings.security.providerLinked': '{{provider}} 連携済み',
    'profile.settings.security.providerLinking': '{{provider}} を連携中...',
  },
  pt: {
    ...
    'login.signal.socialExpanded': '{{providers}} prontos',
    'profile.message.providerLinkUnavailable': 'O vinculo de {{provider}} nao esta disponivel nesta versao.',
    'profile.message.providerLinkRedirect': 'Conclua o vinculo de {{provider}} na janela do provedor.',
    'profile.message.providerAlreadyLinked': '{{provider}} ja esta vinculado a esta conta.',
    'profile.message.providerLinked': '{{provider}} foi vinculado a esta conta.',
    'profile.message.providerLinkFailed': 'Nao foi possivel vincular {{provider}}.',
    'profile.settings.security.linkedProviders': 'Provedores de login vinculados',
    'profile.settings.security.linkedProvidersBody': 'Adicione outro provedor depois de entrar com o metodo que ja possui este email.',
    'profile.settings.security.providerLink': 'Vincular {{provider}}',
    'profile.settings.security.providerLinked': '{{provider}} vinculado',
    'profile.settings.security.providerLinking': 'Vinculando {{provider}}...',
  },
  zh: {
    ...
    'voice.title': 'Aura Voice Assistant',
    'footer.headline': 'Commerce should feel assured before it feels fast.',
    'login.signal.socialExpanded': '{{providers}} 已就绪',
    'profile.message.providerLinkUnavailable': '此版本不支持关联 {{provider}}。',
    'profile.message.providerLinkRedirect': '请在提供商窗口完成 {{provider}} 关联。',
    'profile.message.providerAlreadyLinked': '{{provider}} 已关联到此账户。',
    'profile.message.providerLinked': '已将 {{provider}} 关联到此账户。',
    'profile.message.providerLinkFailed': '无法关联 {{provider}}。',
    'profile.settings.security.linkedProviders': '已关联的登录提供商',
    'profile.settings.security.linkedProvidersBody': '请先使用已拥有此邮箱的方法登录，然后再添加其他提供商。',
    'profile.settings.security.providerLink': '关联 {{provider}}',
    'profile.settings.security.providerLinked': '{{provider}} 已关联',
    'profile.settings.security.providerLinking': '正在关联 {{provider}}...',
  },
};
