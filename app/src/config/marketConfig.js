...
const NON_ENGLISH_RUNTIME_MESSAGE_BACKFILL = {
  ...
  'orders.card.toggle': 'Toggle order details',
  'orders.invoice.amount': 'Amount',
  'orders.invoice.back': 'Back to order',
  'orders.invoice.deliveryTo': 'Delivery address',
  'orders.invoice.error': 'Unable to load this invoice.',
  'orders.invoice.footer': 'This invoice was generated from your Aura order record.',
  'orders.invoice.item': 'Item',
  'orders.invoice.items': 'Items',
  'orders.invoice.loading': 'Preparing invoice...',
  'orders.invoice.orderId': 'Order',
  'orders.invoice.payment': 'Payment',
  'orders.invoice.placedOn': 'Placed on',
  'orders.invoice.print': 'Print / Save as PDF',
  'orders.invoice.title': 'Invoice',
  'orders.invoice.total': 'Total',
  'orders.placed.dismiss': 'Dismiss',
  'orders.placed.subtitle': 'Your order is confirmed. Track every step right here — we update this page live.',
  'orders.placed.title': 'Order placed successfully!',
  'orders.progress.latest': 'Latest update received',
