...
const SupportArchitecturePanel = ({
    ...
    <section className={cn('rounded-[2rem] border border-white/10 bg-[linear-gradient(135deg,rgba(6,10,24,0.92),rgba(10,18,34,0.96))] p-5 shadow-[0_28px_80px_rgba(2,8,23,0.35)]', className)}>
