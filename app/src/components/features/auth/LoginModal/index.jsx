...
const LoginModal = ({ isOpen, onClose }) => {
    ...
    return createPortal(
        <div className="fixed inset-0 z-50 flex items-start justify-center overflow-y-auto px-3 py-4 sm:items-center sm:p-4">
            ...
            <div className="bg-white/5 backdrop-blur-2xl rounded-[28px] sm:rounded-[32px] shadow-glass border border-white/10 w-full max-w-md relative overflow-hidden z-10 animate-scale-up shadow-[0_0_50px_rgba(0,0,0,0.8)] max-h-[min(92vh,860px)] overscroll-contain">
