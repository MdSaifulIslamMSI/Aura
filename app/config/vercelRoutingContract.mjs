...
// as the seventh copy). Pages applies `_headers` blocks on top of static
// assets; no `_redirects` file is generated because the storefront bundle
// calls the hosted backend origin directly (same as Netlify/Vercel) and
// Pages' default SPA behavior already routes unknown paths to `/index.html`.
// Regenerated by app/scripts/sync_vercel_configs.mjs.
