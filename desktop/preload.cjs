...
contextBridge.exposeInMainWorld('auraDesktop', {
    ...
    readSecureStorage: (key) => ipcRenderer.invoke('desktop:secure-storage:get', key),
    ...
    writeSecureStorage: (key, value) => ipcRenderer.invoke('desktop:secure-storage:set', key, value),
