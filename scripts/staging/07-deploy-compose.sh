...
mfa_totp_enabled="$(ssm_get MFA_TOTP_ENABLED)"
mfa_passkey_enabled="$(ssm_get MFA_PASSKEY_ENABLED)"
mfa_recovery_codes_enabled="$(ssm_get MFA_RECOVERY_CODES_ENABLED)"
mfa_required_for_admins="$(ssm_get MFA_REQUIRED_FOR_ADMINS)"
mfa_required_for_sellers="$(ssm_get MFA_REQUIRED_FOR_SELLERS)"
mfa_email_otp_fallback_enabled="$(ssm_get MFA_EMAIL_OTP_FALLBACK_ENABLED)"
mfa_challenge_ttl_seconds="$(ssm_get MFA_CHALLENGE_TTL_SECONDS)"
mfa_fresh_window_seconds="$(ssm_get MFA_FRESH_WINDOW_SECONDS)"
mfa_secret_encryption_key="$(ssm_get MFA_SECRET_ENCRYPTION_KEY)"
...
MFA_PASSKEY_ENABLED=$mfa_passkey_enabled
MFA_RECOVERY_CODES_ENABLED=$mfa_recovery_codes_enabled
MFA_REQUIRED_FOR_ADMINS=$mfa_required_for_admins
MFA_REQUIRED_FOR_SELLERS=$mfa_required_for_sellers
MFA_EMAIL_OTP_FALLBACK_ENABLED=$mfa_email_otp_fallback_enabled
MFA_CHALLENGE_TTL_SECONDS=$mfa_challenge_ttl_seconds
MFA_FRESH_WINDOW_SECONDS=$mfa_fresh_window_seconds
