...
const coverage = [
    ...
    ['POST', '/api/admin/privileged-access/grants', 'ADMIN_SECURITY_CONFIG_CHANGE', ['sensitiveActions.adminSecurityConfigChange']],
    ['POST', '/api/admin/privileged-access/grants/:grantId/approve', 'ADMIN_SECURITY_CONFIG_CHANGE', ['sensitiveActions.adminSecurityConfigChange']],
    ['POST', '/api/admin/privileged-access/grants/:grantId/deny', 'ADMIN_SECURITY_CONFIG_CHANGE', ['sensitiveActions.adminSecurityConfigChange']],
    ['POST', '/api/admin/privileged-access/grants/:grantId/revoke', 'ADMIN_SECURITY_CONFIG_CHANGE', ['sensitiveActions.adminSecurityConfigChange']],
    ...
    ['POST', '/api/orders/:id/shipments', 'ORDER_STATUS_CHANGE', ['sensitiveActions.orderStatusChange']],
    ['POST', '/api/orders/:id/shipments/:shipmentId/checkpoints', 'ORDER_STATUS_CHANGE', ['sensitiveActions.orderStatusChange']],
...
const exclusions = new Map([
    ...
    ['POST /api/orders/serviceability', 'Pincode serviceability computation; protected by auth and command-center rate limiters, but it does not persist order state.'],
