...
const shortHash = (value) => crypto.createHash('sha1').update(value).digest('hex').slice(0, 6); // nosemgrep: security.semgrep.nodejs-sha1 — stable i18n discovery id suffix (changing it churns all generated ids); accepted in config/security/pqc-allowlist.json
