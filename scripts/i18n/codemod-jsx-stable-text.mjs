...
const hashText = (value = '') => crypto.createHash('sha1').update(value).digest('hex').slice(0, 8); // nosemgrep: nodejs-sha1 — stable i18n message id suffix (changing it churns all generated ids); accepted in config/security/pqc-allowlist.json
