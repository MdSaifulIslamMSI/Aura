...
| R-006 | Managed DB backup restore proof is not retained | Medium | Critical | Backup policy docs, configuration-only backup verifier, local isolated restore drill | Data owner | Partial | Monthly managed-backup restore drill record |
