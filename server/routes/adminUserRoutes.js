...
router.post('/:userId/warn', protect, admin, validate(adminWarnUserSchema), requireTrustDecision('admin.user.moderate', loadUserResource), sensitiveActions.adminUserMutation, warnAdminUser);
...
router.post('/:userId/dismiss-warning', protect, admin, validate(adminDismissWarningSchema), requireTrustDecision('admin.user.moderate', loadUserResource), sensitiveActions.adminUserMutation, dismissAdminUserWarning);
