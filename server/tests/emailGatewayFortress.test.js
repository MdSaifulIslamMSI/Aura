describe('Email Gateway Fortress', () => {
    ...
    test('rejects missing eventType in strict mode', async () => {
        ...
        process.env.EMAIL_FORTRESS_ENABLED = 'true';
    ...
    test('rejects subject over configured limit', async () => {
        ...
        process.env.EMAIL_FORTRESS_ENABLED = 'true';
        process.env.EMAIL_FORTRESS_STRICT_MODE = 'true';
        process.env.EMAIL_FORTRESS_MAX_SUBJECT_LEN = '20';
    ...
    test('sends sanitized payload with default fortress headers', async () => {
        process.env.ORDER_EMAILS_ENABLED = 'true';
        process.env.EMAIL_FORTRESS_ENABLED = 'true';
        process.env.EMAIL_FORTRESS_STRICT_MODE = 'true';
        ...
        expect(payload.headers['X-Aura-Message-Version']).toBe('fortress-v3');
