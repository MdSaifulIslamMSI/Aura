...
const buildStableUid = ({
    ...
    brand = '',
    category = '',
}) => crypto.createHash('sha1') // nosemgrep: security.semgrep.nodejs-sha1 — deterministic product UID hash (identity stability, not a security primitive); accepted in config/security/pqc-allowlist.json
